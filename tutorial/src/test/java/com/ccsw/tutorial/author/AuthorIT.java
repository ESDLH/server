...
public class AuthorIT {
    ...
    @Test
    public void modifyWithNotExistIdSouldThrowException() {
    ...
    @Test
    public void deleteWithExistIdShouldDeleteCategory() {
    ...
    @Test
    public void deleteWithNotExistsShouldThrowException() {
